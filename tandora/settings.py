...
USER_CUSTOM_DOMAIN_URL = os.environ.get('USER_CUSTOM_DOMAIN_URL')
USER_CUSTOM_DOMAIN_TOKEN = os.environ.get('USER_CUSTOM_DOMAIN_TOKEN')

TANDORA_CHANGELOG_KEY = os.environ['TANDORA_CHANGELOG_KEY']

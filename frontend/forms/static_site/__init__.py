...
FONT_CHOICES = (
    ...
    ('https://fonts.googleapis.com/css?family=Inter&display=swap', 'Inter'),
    ('https://fonts.googleapis.com/css?family=Padauk&display=swap', 'Padauk'),
    ('https://fonts.googleapis.com/css?family=Harmattan&display=swap', 'Harmattan'),

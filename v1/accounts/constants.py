...
INACTIVE_USER_ADMIN_ERROR = _('You cannot perform  this action since the user is inactive.')
NOT_ALLOWED_COMPANY_NAME = _('This company name is not allowed.')
...
SPECIAL_CHARACTERS_NOT_ALLOWED = _('Special characters or spaces are not allowed for this field.')
